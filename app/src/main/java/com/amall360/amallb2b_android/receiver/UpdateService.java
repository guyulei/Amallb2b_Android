...
public class UpdateService extends Service {
    ...
    private void initDownManager() {
        ...
        //设置下载地址
        DownloadManager.Request down = new DownloadManager.Request(Uri.parse(ApiUrlBase.apk_path));
        ...
        // 设置下载后文件存放的位置
        down.setDestinationInExternalFilesDir(this, Environment.DIRECTORY_DOWNLOADS, "在线监理.apk");
        // 将下载请求放入队列
